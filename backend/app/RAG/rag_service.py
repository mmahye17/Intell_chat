...
from backend.app.config.Global_config import (
...
from backend.app.RAG.reranker import DashScopeReranker
...
def hybrid_search(conv_id: int, query: str, top_k: int = 5, top_n: int = 3) -> list[dict]:
    ...
    from backend.app.RAG.reranker import DashScopeReranker as _R
